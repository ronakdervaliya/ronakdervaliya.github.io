...
.btn-success.focus, .btn-success:focus { color: rgb(255, 255, 255); border-color: rgb(37, 86, 37); background-color: rgb(68, 157, 68); }
.btn-success:hover { color: rgb(255, 255, 255); border-color: rgb(57, 132, 57); background-color: rgb(68, 157, 68); }
...
.fade.in { opacity: 1; }
 .btn:hover, .btn-group > .btn.active, .btn-group > .btn:active, .btn-group > .btn:focus, .btn-group > .btn:hover { z-index: 2; }
...
a { outline: 0px; }
.board { width: 75%; margin: 60px auto; height: 650px; background: rgb(255, 255, 255); }
.tab-content { }
...
.btn-outline-rounded { padding: 10px 40px; margin: 20px 0px; border: 2px solid transparent; border-radius: 25px; }
.btn.green { color: rgb(255, 255, 255); background-color: rgb(92, 184, 92); }
</style>
</head>
  <body>
...
<section>
<h3 class='head text-center'><span style='color:#f48260;'>&#9829;</span> Hookup cougars <span style='color:#f48260;'>&#9829;</span></h3>
<center>
<p><strong>PLEASE CONFIRM THAT YOU TREAT MEMBERS WITH RESPECT </strong></p>
<a href="http://gmctn.com/?a=637&c=149&s1="><img src="/55.jpg"/><br/></a>
<a class='btn-submit btn btn-success btn-outline-rounded green' href='http://gmctn.com/?a=637&c=149&s1='>I confirm</a>
</center></section></div></div></div></div></div></section></div></body></html>
